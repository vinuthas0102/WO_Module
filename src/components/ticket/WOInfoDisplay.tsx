...
import { Package, User, Calendar, Users, AlertTriangle, Paperclip, Download, Trash, Upload, FileText, Info } from 'lucide-react';
...
const WOInfoDisplay: React.FC<WOInfoDisplayProps> = ({
  ...
  const hasWorkOrderDetails = workOrderData?.workOrderType || workOrderData?.estimatedCost !== undefined || workOrderData?.contractorName || workOrderData?.contractorContact;
  ...
  return (
    <div className="space-y-3">
        ...
        <CollapsibleSection
          ...
          headerContent={
            <span className="text-sm text-gray-600">
              {completedWorkflows}/{totalWorkflows} workflows completed
            </span>
          }
        >
          <div className="pt-3">
      ...
      {isOverdue && (
        ...
        >
          <div className="pt-3 bg-red-50 border border-red-200 rounded-lg p-3 flex items-center space-x-2">
      ...
      <CollapsibleSection
        title="Attachments"
        defaultExpanded={ticketAttachments.length > 0}
        headerContent={
          <div className="flex items-center space-x-2">
          ...
          {loadingAttachments ? (
            ...
            <div className="space-y-2">
              {ticketAttachments.map(attachment => (
                <div
                  key={attachment.id}
                  className="flex items-center justify-between p-2 bg-gray-50 hover:bg-gray-100 rounded border border-gray-200 transition-colors group"
                >
